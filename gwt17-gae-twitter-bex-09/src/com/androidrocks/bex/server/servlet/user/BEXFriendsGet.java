 ...
 * @author muthu
 */
public class BEXFriendsGet extends HttpServlet {

    private static final Logger log = Logger.getLogger(BEXFriendsGet.class
            .getName());
...
// todo: set refresh from client
                ...
                List<Friend> friends = UserManager.fetchBEXFriends(user);
// prepare the output
