 ...
 * @author muthu
 */
public class TwitFollowersGet extends HttpServlet {

    private static final Logger log = Logger.getLogger(TwitFollowersGet.class
            .getName());
...
// todo: set refresh from client
                UserManager.fetchTwitterFollowers(user);
