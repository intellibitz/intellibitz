...
| **Python & AI** | [`lang/python/`](file:///home/ramadoss/github.com/intellibitz/intellibitz/os/lang/python) | Anaconda/Miniconda setup, Jupyter notebooks, Hugging Face Hub CLI guide (`huggingface.md`), Google Colab & Gemini API (`colab.md`), Meta Llama 3 (`meta-llama.md`). |
