 ...
 * instance.
 */
public class GLFightSurface extends SurfaceView implements SurfaceHolder.Callback {
    GLFightSurface(Context context) {
        super(context);
        init();
    }

    public GLFightSurface(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
