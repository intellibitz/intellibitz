 ...
 * @author muthu
 */
public class TradeMatchGet extends HttpServlet {

    private static final Logger log = Logger.getLogger(TradeMatchGet.class
            .getName());
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (null == user) {
            ...
            List<TradeMatch> matches = MatchManager.matchTradeList(user);
            List<Match> jsonMatches = TypeFactory.tradeMatchJson (matches);
// prepare the output
