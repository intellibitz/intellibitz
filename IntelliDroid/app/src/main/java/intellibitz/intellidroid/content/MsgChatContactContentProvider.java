 ...
 *
 */
public class MsgChatContactContentProvider extends
        ContentProvider {

    public static final String TAG = "MsgChatContactCP";
    public static final String TABLE_MSGCHATCONTACT = "msgchatcontact";
    public static final String TABLE_MSGCHATCONTACT_INTELLIBITZCONTACTS_JOIN = "msgchatcontact_intellibitzcontacts";
    public static final String CREATE_TABLE_MSGCHATCONTACT = "CREATE TABLE "
            + TABLE_MSGCHATCONTACT + ContactItemColumns.TABLE_CONTACTS_SCHEMA;
    ...
    public static final String CREATE_TABLE_MSGCHATCONTACT_INTELLIBITZCONTACTS_JOIN = "CREATE TABLE "
            + TABLE_MSGCHATCONTACT_INTELLIBITZCONTACTS_JOIN + "( " +
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(AUTHORITY, TABLE_MSGCHATCONTACT +
                "/#", CONTACT_ITEM_TYPE);
        matcher.addURI(AUTHORITY, TABLE_MSGCHATCONTACT +
                "/*", CONTACT_DATA_ITEM_TYPE);
        matcher.addURI(AUTHORITY,
                "join_" + TABLE_MSGCHATCONTACT, CONTACT_JOIN_DIR_TYPE);
        matcher.addURI(AUTHORITY,
                "join_" + TABLE_MSGCHATCONTACT +
                        "/#", CONTACT_JOIN_ITEM_TYPE);
        matcher.addURI(AUTHORITY,
                "join_" + TABLE_MSGCHATCONTACT +
                        "/*", CONTACT_JOIN_DATA_ITEM_TYPE);
        matcher.addURI(AUTHORITY,
                "raw_" + TABLE_MSGCHATCONTACT, CONTACT_RAW_DIR_TYPE);
        // to get suggestions...
...
*/
    ...
    public static long createOrUpdateContactIntellibitzContactByContactJoin(DatabaseHelper databaseHelper,
                                                                            SQLiteDatabase db, ContactItem contactItem, long id) {
...
//            the hack is for msg thread groups.. so it can get device contact from contact item
    ...
    public static Cursor getContactIntellibitzContactCursorJoin(DatabaseHelper databaseHelper,
        ...
        String selectQuery = "SELECT  * FROM " + MsgChatContactContentProvider.TABLE_MSGCHATCONTACT + " nt " +
                " left join " + TABLE_MSGCHATCONTACT_INTELLIBITZCONTACTS_JOIN +
...
//        Log.e(TAG, selectQuery);
    ...
    public static long createOrUpdateContactIntellibitzContactJoin(
        ...
        if (0 == _id) {
            ...
            _id = databaseHelper.update(db,
                    TABLE_MSGCHATCONTACT_INTELLIBITZCONTACTS_JOIN, values,
    ...
    public static long getContactIntellibitzContactJoin(
            DatabaseHelper databaseHelper, SQLiteDatabase db, long id, long fk) {
        long _id = 0;
        Cursor c = databaseHelper.query(db, TABLE_MSGCHATCONTACT_INTELLIBITZCONTACTS_JOIN,
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        switch (URI_MATCHER.match(uri)) {
            ...
            case CONTACT_JOIN_DIR_TYPE:
                try {
                    cursor = databaseHelper.query(TABLE_MSGCHATCONTACT,
                            projection,
            ...
            case CONTACT_ITEM_TYPE:
                try {
                    ...
                    Uri insertUri = ContentUris.withAppendedId(
                            MsgChatContactContentProvider.CONTENT_URI, id);
                    Context context = getContext();
                    if (null != context) {
...
//                    context.getContentResolver().notifyChange(uri, null);
    ...
    public int update(@NonNull Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (URI_MATCHER.match(uri)) {
            ...
            case CONTACT_ITEM_TYPE:
                try {
                    id = databaseHelper.update(TABLE_MSGCHATCONTACT,
                            values,
                            selection, selectionArgs);
                    updateUri = ContentUris.withAppendedId(MsgChatContactContentProvider.CONTENT_URI, id);
                    if (null != context) {
    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (URI_MATCHER.match(uri)) {
            ...
            case CONTACT_ITEM_TYPE:
                try {
                    int id = databaseHelper.delete(TABLE_MSGCHATCONTACT,
                            selection, selectionArgs);
                    Uri delUri = ContentUris.withAppendedId(MsgChatContactContentProvider.CONTENT_URI, id);
                    Context context = getContext();
                    if (null != context) {
