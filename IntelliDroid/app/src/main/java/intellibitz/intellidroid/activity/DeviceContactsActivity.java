...
public class DeviceContactsActivity extends
        IntellibitzTwoPaneUserActivity implements
        ContactListener {
    private static final String TAG = "DeviceContactsAct";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_devicecontacts);
    ...
    private void setupFragments() {
        final DeviceContactsFragment deviceContactsFragment =
                DeviceContactsFragment.newInstance(user, this);
