...
import intellibitz.intellidroid.fragment.ProfileInfoFragment;
...
public class ProfileInfoActivity extends
...
//            newLoginFragment(savedInstanceState);
    ...
    private void setupFragments() {
        final ProfileInfoFragment profileInfoFragment =
                ProfileInfoFragment.newInstance(user);
        replaceContentFragment(profileInfoFragment);
    }
