...
public class MediaPicker {
     ...
     * @param result   Can fail to createFileInES the file needed for the camera intents.
     */
     ...
     * @throws IOException
     */
    private static Uri createTempImageFileAndPersistUri(
            final Activity activity, final Fragment fragment) throws
            IOException {
        final Context context = activity != null ? activity : fragment.getContext();
