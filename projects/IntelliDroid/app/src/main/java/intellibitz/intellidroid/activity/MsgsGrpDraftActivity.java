...
import intellibitz.intellidroid.fragment.MsgsGrpDraftFragment;
...
public class MsgsGrpDraftActivity extends
        IntellibitzTwoPaneUserActivity implements
        PeopleListener {
    private static final String TAG = "MsgsGrpDraftAct";
...
*/
    ...
    private void setupFragments() {
        final MsgsGrpDraftFragment msgsGrpDraftFragment =
                MsgsGrpDraftFragment.newInstance(messageItem, user, this);
//        msgsGrpNestFragment.onMessageForward(getIntent());
//                MsgsGrpNestFragment.newInstance(messageItem, user, this);
        replaceContentFragment(msgsGrpDraftFragment);
    }
