...
public class MsgsGrpPeopleActivity extends
        IntellibitzTwoPaneUserActivity implements
        PeopleListener {
    private static final String TAG = "MsgsGrpPeopleAct";
...
//        LocalBroadcastManager.getInstance(this).unregisterReceiver(messageToNestReceiver);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_msgsgrppeople);
...
*/
    ...
    private void setupFragments() {
        final MsgsGrpPeopleFragment msgsGrpPeopleFragment =
