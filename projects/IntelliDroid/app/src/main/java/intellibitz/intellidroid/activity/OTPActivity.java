...
import intellibitz.intellidroid.fragment.OTPFragment;
import intellibitz.intellidroid.IntellibitzTwoPaneUserActivity;
import intellibitz.intellidroid.MainActivity;
...
public class OTPActivity extends
...
//        setupAppBar();
    ...
    private void setupFragments() {
        final OTPFragment otpFragment =
//                LoginFragment.newInstance(user, this);
                OTPFragment.newInstance(user);
        replaceContentFragment(otpFragment);
    }
