...
import intellibitz.intellidroid.fragment.MsgChatGrpContactsDetailFragment;
...
public class MsgChatGrpContactsDetailActivity extends
        IntellibitzTwoPaneUserActivity implements ContactListener {
    private static final String TAG = "MsgChatGrpCtsDetailAct";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_msgchatgrpcontactsdetail);
...
//            NavUtils.navigateUpFromSameTask(this);
    ...
    private void setupFragments() {
        final MsgChatGrpContactsDetailFragment msgChatGrpContactsDetailFragment =
                MsgChatGrpContactsDetailFragment.newInstance(contactItem, user, this);
        replaceContentFragment(msgChatGrpContactsDetailFragment);
    }
