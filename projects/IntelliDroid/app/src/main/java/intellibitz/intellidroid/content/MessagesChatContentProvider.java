...
import static intellibitz.intellidroid.content.MessageChatContentProvider.createOrUpdateMessages;
...
public class MessagesChatContentProvider extends
    ...
    public static final String AUTHORITY =
            "intellibitz.intellidroid.content.MessagesChatContentProvider";
        ...
        switch (URI_MATCHER.match(uri)) {
            ...
            case MESSAGESCHAT_JOIN_DIR_TYPE:
                try {
                    ...
                    long[] ids = MessageChatContentProvider.createOrUpdateMessages(databaseHelper, items);
            ...
            case MESSAGESCHAT_DATA_ITEM_TYPE:
                try {
                    MessageItem item = (MessageItem)
                            MainApplicationSingleton.Serializer.deserialize(vals);
                    long id = MessageChatContentProvider.createOrUpdateMessages(databaseHelper, item);
        ...
        switch (URI_MATCHER.match(uri)) {
            ...
            case MESSAGESCHAT_JOIN_DATA_ITEM_TYPE:
                try {
                    ...
                    id = (int) MessageChatContentProvider.createOrUpdateMessages(databaseHelper, item);
