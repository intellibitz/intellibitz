	...
	function createXMLHttpRequest() {
     ...
     hint[0]="<strong><font size=\"1\" face=\"MS Sans Serif, Tahoma, sans-serif\" color=\"#FFFFFF\">สังคมดีดีเกิดขึ้นได้หากทุกคนร่วมมือกันนะครับ ใครทำตัวไม่เหมาะสมระวังโดนแบนน้า </font></strong><font face=\"MS Sans Serif, Tahoma, sans-serif\"><a href=\"#\" onClick=\"History()\">[บันทึกการสนทนา]</a></font>";
     hint[1]="<strong><font size=\"1\" face=\"MS Sans Serif, Tahoma, sans-serif\" color=\"#FFFFFF\">หากต้องการสนทนาแบบส่วนตัว ให้กดที่ชื่อด้านขวาเพื่อเลือกพูดคุยแบบตัวต่อตัว </font></strong><font face=\"MS Sans Serif, Tahoma, sans-serif\"><a href=\"#\" onClick=\"History()\">[บันทึกการสนทนา]</a></font>";
     hint[2]="<strong><font size=\"1\" face=\"MS Sans Serif, Tahoma, sans-serif\" color=\"#FFFFFF\">รูปแบบใหม่ประจำแชทคือการพูดคุยแบบกลุ่ม GroupMode โดยเลือกที่เมนูด้านขวา </font></strong><font face=\"MS Sans Serif, Tahoma, sans-serif\"><a href=\"#\" onClick=\"History()\">[บันทึกการสนทนา]</a></font>";   
     hint[3]="<strong><font size=\"1\" face=\"MS Sans Serif, Tahoma, sans-serif\" color=\"#FFFFFF\">พูดคุยกันด้วยวาจาที่สุภาพดีต่อตัวเอง และคนที่คุยด้วยนะครับ เราจะได้เป็นมิตรที่ดีต่อกัน </font></strong><font face=\"MS Sans Serif, Tahoma, sans-serif\"><a href=\"#\" onClick=\"History()\">[บันทึกการสนทนา]</a></font>";
     hint[4]="<strong><font size=\"1\" face=\"MS Sans Serif, Tahoma, sans-serif\" color=\"#FFFFFF\">หากพบปัญหาใด ๆ หรือต้องการสคริปต์แชทสามารถติดต่อมาได้ที่ service@thaimess.com </font></strong><font face=\"MS Sans Serif, Tahoma, sans-serif\"><a href=\"#\" onClick=\"History()\">[บันทึกการสนทนา]</a></font>";
...
document.forms[0].data.focus();
		...
		if(mystatus=="DJ")
		{
		checkpass = prompt("กรุณาใส่รหัสที่ใช้เปิดเพลง");
		}
		...
		if((mystatus!="DJ") || (mystatus=="DJ" && checkpass=="password"))
		{
			...
			{
			alert("รหัสไม่ถูกต้อง นั่นแน่จะสวมรอยเป็นดีเจหรือยังไง !!!");
			}
