 ...
 * @author muthu
 */
public class WishListGet extends HttpServlet {

    private static final Logger log = Logger.getLogger(WishListGet.class
            .getName());
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (null == user) {
            ...
            List<Book> books = UserManager.fetchWishBook(user);
// prepare the output
