 ...
 */
public class ResultInstrumentationTest extends ActivityInstrumentationTestCase<Result> {

    public ResultInstrumentationTest() {
        super("com.fiteclub.android", Result.class);
    }
