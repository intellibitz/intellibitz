...
public class CompanyCreateActivity extends
        IntellibitzTwoPaneUserActivity {

    private static final String TAG = "CompCreateAct";
...
//        setupAppBar();
    ...
    private void setupFragments() {
        final CompanyCreateFragment companyCreateFragment =
                CompanyCreateFragment.newInstance(user);
        replaceContentFragment(companyCreateFragment);
    }
