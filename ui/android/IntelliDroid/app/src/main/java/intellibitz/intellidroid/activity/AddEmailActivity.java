...
import intellibitz.intellidroid.fragment.AddEmailFragment;
...
public class AddEmailActivity extends
...
//            newLoginFragment(savedInstanceState);
    ...
    private void setupFragments() {
        final AddEmailFragment addEmailFragment =
                AddEmailFragment.newInstance(user);
        replaceContentFragment(addEmailFragment);
    }
        ...
        if (upAlert) {
            ...
            snack.setAction("SWITCH", new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(AddEmailActivity.this,
