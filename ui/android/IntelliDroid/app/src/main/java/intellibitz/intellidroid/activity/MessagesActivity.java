...
import intellibitz.intellidroid.fragment.MessagesFragment;
...
public class MessagesActivity extends
        IntellibitzTwoPaneUserActivity implements
        PeopleListener {
    private static final String TAG = "MessagesAct";
...
*/
    ...
    private void setupAppBar() {
        ...
        toolbar.setTitle(R.string.toolbar_messages_title);
    ...
    private void setupFragments() {
        final MessagesFragment messagesFragment =
                MessagesFragment.newInstance(messageItem, user, this);
//        msgsGrpNestFragment.onMessageForward(getIntent());
//                MsgsGrpNestFragment.newInstance(messageItem, user, this);
        replaceContentFragment(messagesFragment);
    }
