...
public class CompanyListActivity extends
        IntellibitzTwoPaneUserActivity {

    private static final String TAG = "CompanyListAct";
...
//        setupAppBar();
    ...
    private void setupFragments() {
        final CompanyListFragment companyListFragment =
                CompanyListFragment.newInstance(user);
        replaceContentFragment(companyListFragment);
    }
