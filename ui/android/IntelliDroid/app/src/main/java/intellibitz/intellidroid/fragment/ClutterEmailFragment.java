 ...
 *
 */
public class ClutterEmailFragment extends
...
//                    shareCurrentItem();
     ...
     */
    public ClutterEmailFragment() {
        super();
    }

    public static ClutterEmailFragment newInstance(
            MessageItem messageItem, ContactItem user, ClutterListener clutterListener) {
        ClutterEmailFragment fragment = new ClutterEmailFragment();
...
//                                    the cloud treats this doc type as draft
                                    ...
                                    messageItem.setChatId(ClutterEmailFragment.this.messageItem.getChatId());
                                    messageItem.setDataId(ClutterEmailFragment.this.messageItem.getChatId());
//                                        // TODO: 19-06-2016
...
*/
                            ...
                            ClutterEmailFragment.this.quitDraftLooperThread();
                        }
                    });
                    etMessageInput.setEnabled(true);
                    etMessageInput.setText("");
...
*/
                            ClutterEmailFragment.this.quitLooperThread();
                        }
                    });
//                    sendMessage(messageItem, user);
...
//        lets the listeners know for the new headers
        if (emailMessageHeaderListener != null)
...
//        intellibitzActivity.onBackPressed(intent);
        ...
        intent.setAction(ClutterEmailFragment.TAG);
...
//                    converts to milliseconds, for correct date conversion
            ...
            String fromName = holder.mItem.getFromName();
            if (TextUtils.isEmpty(userName)) {
                userName = user.getSignupEmail();
                fromName = holder.mItem.getFromEmail();
            }
            if (!TextUtils.isEmpty(userName) && userName.equals(fromName)) {
//                    ||
