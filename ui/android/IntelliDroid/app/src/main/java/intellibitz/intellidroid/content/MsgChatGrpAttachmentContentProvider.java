 ...
 *
 */
public class MsgChatGrpAttachmentContentProvider extends
        ContentProvider {

    public static final String TAG = "MsgChatGrpAttachmentCP";
    public static final String TABLE_MSGCHATGRPATTACHMENT = "msgchatgrpattachment";
    public static final String CREATE_TABLE_MSGCHATGRPATTACHMENT = "CREATE TABLE "
    ...
    public static void setAttachmentItemFromJson(MessageItem attachmentMessage, JSONObject response) throws
        ...
        attachmentMessage.setMessageType(MessageItem.GROUP);
        attachmentMessage.setGroup(true);
    }
...
//        checks if the same email attachment is already present for the message thread
        ...
        Cursor cursor = databaseHelper.query(TABLE_MSGCHATGRPATTACHMENT,
                new String[]{
                        MessageItemColumns.KEY_ID
...
//        creates the join
    ...
    public static Cursor getAllMessageAttachmentsCursor(
        ...
        String selectQuery = "SELECT  * FROM " + MessageChatGroupContentProvider.TABLE_MESSAGECHATGROUP + " msgs " +
...
//        Log.e(TAG, selectQuery);
    ...
    public static long updateMessageThreadMessageChatAttachmentURL(
        ...
        int row = databaseHelper.update(TABLE_MSGCHATGRPATTACHMENT, values,
...
//        fetch the attachment and send the id back.. for content updates
    ...
    public static long getMessageAttachmentJoin(DatabaseHelper databaseHelper, long id, long fk) {
        long _id = 0;
        Cursor c = databaseHelper.query(MessageChatGroupContentProvider.TABLE_MESSAGECHATGROUP_ATTACHMENTS_JOIN, new String[]{IntellibitzItemColumns.KEY_ID},
    ...
    public static void asyncUpdateChatGroupAttachmentFilePathInDB(
...
//        intent service runs async in its own thread
            ...
            intent.setAction(MainApplicationSingleton.INTENT_ACTION_FETCH_CHATGROUP_ATTACHMENT_CLOUD);
