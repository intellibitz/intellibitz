...
import intellibitz.intellidroid.fragment.PeopleDetailFragment;
...
public class PeopleDetailActivity extends
...
//        setupAppBar();
    ...
    private void setupFragments() {
        final PeopleDetailFragment peopleDetailFragment =
                PeopleDetailFragment.newInstance(messageItem, user, this);
        replaceContentFragment(peopleDetailFragment);
    }
