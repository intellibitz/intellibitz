...
public class MsgsGrpClutterActivity extends
        IntellibitzTwoPaneUserActivity implements
        ClutterListener {
    private static final String TAG = "MsgsGrpClutterAct";
...
//        LocalBroadcastManager.getInstance(this).unregisterReceiver(messageToNestReceiver);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_msgsgrpclutter);
...
*/
    ...
    private void setupAppBar() {
        ...
        toolbar.setTitle(R.string.clutter_box);
    ...
    private void setupFragments() {
        final MsgsGrpClutterFragment msgsGrpClutterFragment =
