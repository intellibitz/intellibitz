...
public class GetInvitesActivity extends
        IntellibitzTwoPaneUserActivity {

    private static final String TAG = "GetInvitesAct";
...
//        setupAppBar();
    ...
    private void setupFragments() {
        final GetInvitesFragment getInvitesFragment =
                GetInvitesFragment.newInstance(user);
        replaceContentFragment(getInvitesFragment);
    }
