...
import intellibitz.intellidroid.fragment.AddEmailsFragment;
...
public class AddEmailsActivity extends
        IntellibitzTwoPaneUserActivity {

    private static final String TAG = "AddEmailsActivity";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_addemails);
...
//            newLoginFragment(savedInstanceState);
    ...
    private void setupFragments() {
        final AddEmailsFragment addEmailsFragment =
                AddEmailsFragment.newInstance(user);
        replaceContentFragment(addEmailsFragment);
    }
        ...
        if (upAlert) {
            ...
            snack.setAction("SWITCH", new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(AddEmailsActivity.this,
