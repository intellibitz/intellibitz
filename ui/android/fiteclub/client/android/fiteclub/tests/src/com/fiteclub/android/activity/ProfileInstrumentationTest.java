 ...
 */
public class ProfileInstrumentationTest extends ActivityInstrumentationTestCase<Profile> {

    public ProfileInstrumentationTest() {
        super("com.fiteclub.android", Profile.class);
    }
