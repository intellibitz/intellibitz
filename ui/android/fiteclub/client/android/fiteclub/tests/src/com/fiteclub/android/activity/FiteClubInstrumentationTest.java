 ...
 */
public class FiteClubInstrumentationTest extends ActivityInstrumentationTestCase<FiteClub> {

    public FiteClubInstrumentationTest() {
        super("com.fiteclub.android", FiteClub.class);
    }
