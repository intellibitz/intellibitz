 ...
 */
public class RankingsInstrumentationTest extends ActivityInstrumentationTestCase<Rankings> {

    public RankingsInstrumentationTest() {
        super("com.fiteclub.android", Rankings.class);
    }
